...
How to import flash cards:
    ...
    To inport your own flash cards, you need to have your terms and definitions set up like:
    "term 1"(tab)"definition for term 1"(return) (next term and definition and repeate that process untill done)
